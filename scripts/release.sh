...
# Cuts a release.
#
#   ./scripts/release.sh 1.0-RC5            # tag, push, wait for CI, report
#   ./scripts/release.sh 1.0-RC5 --dry-run  # say what it would do, change nothing
...
[[ -n "$version" ]] || fail "which version? e.g. $0 1.0-RC5"
