...
# Cuts a release.
#
#   ./scripts/release.sh Beta22            # tag, push, wait for CI, report
#   ./scripts/release.sh Beta22 --dry-run  # say what it would do, change nothing
...
[[ -n "$version" ]] || fail "which version? e.g. $0 Beta22"
